...
class Record(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "content", "ttl", "prio", "disabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "content", "ttl", "prio", "disabled", ], str]):
