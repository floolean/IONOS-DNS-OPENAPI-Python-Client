...
class DynamicDns(
    ...
    class MetaOapg:
        ...
        class properties:
            bulkId = schemas.StrSchema
            updateUrl = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["bulkId"]) -> MetaOapg.properties.bulkId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["updateUrl"]) -> MetaOapg.properties.updateUrl: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["bulkId", "updateUrl", "domains", "description", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["bulkId"]) -> typing.Union[MetaOapg.properties.bulkId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["updateUrl"]) -> typing.Union[MetaOapg.properties.updateUrl, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["bulkId", "updateUrl", "domains", "description", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        bulkId: typing.Union[MetaOapg.properties.bulkId, str, schemas.Unset] = schemas.unset,
        updateUrl: typing.Union[MetaOapg.properties.updateUrl, str, schemas.Unset] = schemas.unset,
