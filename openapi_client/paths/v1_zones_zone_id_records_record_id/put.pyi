...
# body param
SchemaForRequestBodyApplicationJson = RecordUpdate


request_body_record_update = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = RecordResponse
...
class BaseApi(api_client.Api):
    ...
    def _update_record_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_record_update.serialize(body, content_type)
