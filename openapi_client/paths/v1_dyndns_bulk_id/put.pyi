...
# Path params
BulkIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'bulkId': typing.Union[BulkIdSchema, str, ],
    }
)
...
request_path_bulk_id = api_client.PathParameter(
    name="bulkId",
...
# body param
SchemaForRequestBodyApplicationJson = DynDnsRequest


request_body_dyn_dns_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_dyn_dns_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_dyn_dns_request.serialize(body, content_type)
...
class UpdateDynDns(BaseApi):
    ...
    def update_dyn_dns(
        ...
        return self._update_dyn_dns_oapg(
            body=body,
